...
@section('content')
<div class="md:mx-96 text-start md:px-8 justify-center">
    <div class="grid justify-content-center">
        <div class="md:grid-cols-6">
            <div class="card border rounded-md shadow-lg md:p-16 p-10 text-center">
               
                <div class="text-2xl pl-4 font-bold font-b612 text-blue-500 my-7">
                    {{  __('Login') }}
                </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-3">
                            <label for="email" class=" md:col-span-2 col-form-label md:text-end text-xl mr-28 pb-4">{{ __('Email Address') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="password" class="col-md-4 col-form-label text-md-end text-xl pr-36">{{ __('Password') }}</label>
