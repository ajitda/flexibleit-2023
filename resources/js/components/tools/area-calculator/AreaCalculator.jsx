                    ...
                    <div class='container md:mb-8 mb-14'>
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className='row mt-5'>
                                <div className='grid md:grid-cols-4 md:gap-24 grid-cols-1 pl-7'>       
                                    <div class="">
                                        <div class="form-group">
                                            <label class="block">
                                                Side A (feet):
                                                <br /><input type="number" class='form-control border-2 border-sky-500 w-52 h-14 p-2' value={sideA} onChange={(e) => setSideA(e.target.value)} />
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="">
                                        <div class="form-group">
                                            <label class="block">
                                                Side B (feet):
                                                <br /><input type="number" class='form-control border-2 border-sky-500 w-52 h-14 p-2' value={sideB} onChange={(e) => setSideB(e.target.value)} />
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="">
                                        <div class="form-group">
                                            <label class="block">
                                                Side C (feet):
                                                <br /><input type="number" class='form-control border-2 border-sky-500 w-52 h-14 p-2' value={sideC} onChange={(e) => setSideC(e.target.value)} />
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    {shape === 'triangle' ? '' :
                                        <div class="">
                                            <div class="form-group">
                                                <label class="block">
                                                    Side D (feet):
                                                    <br /><input type="number" class='form-control border-2 border-sky-500 w-52 h-14 p-2' value={sideD} onChange={(e) => setSideD(e.target.value)} />
                                                </label>
                                            </div>
                                        </div>
                                    }
                        ...
                        <div className='row mt-5 md:pb-14 px-5'>
                            <div class='border-2'>
                                {areas?.map((ar, ind)=>(
