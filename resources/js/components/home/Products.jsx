    ...
    <div>
        ...
        <div className='grid md:grid-cols-2 gap-4'>
            <div className='bg-slate-200 text-center'>
                ...
                <h1 className='text-xl font-semibold px-5'>e-Manager - a business management software</h1>
                <p className={`${styles.paragraph} px-10`}>Create Invoice/Bill, Automated Report, Get Stock Report</p>
            ...
            <div className='bg-slate-200 text-center'>
                ...
                <h1 className='text-xl font-semibold px-20'>Free QR Code Generator - FlexQR</h1>
                <p className={`${styles.paragraph} px-8`}>create QR for your website, information and company profile.</p>
