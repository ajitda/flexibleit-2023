...
const TestomonialCreate = () => {
    ...
    const handleSubmit = async(e) => {
      ...
      if (media.length > 0) {
       const uploads = await uploadFiles(media);
         ...
         testomonialData.media = uploads ;
       }
       axios.post('/api/testomonials', testomonialData).then(res => {
  ...
  return (
    ...
    <h1 className='text-xl mb-5 font-medium'>Create Testomonial</h1>
   ...
   <div className="flex flex-wrap -mx-3 mb-6">
     <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
       ...
       <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Your Name" name='title' onChange={(e)=>setAuthorName(e.target.value)}/>
     ...
     <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
       ...
       <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Designation" name='designation' onChange={(e)=>setDesignation(e.target.value)}/>
       {/* <p className="text-red-500 text-xs italic">Please fill out this field.</p> */}
     </div>
...
export default TestomonialCreate