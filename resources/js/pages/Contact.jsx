...
const Contact = () => {
   ...
   return (<>
      <div>
         ...
         <div>
            <h3 className="text-xl font-medium mb-2 flex items-center"> <MdOutlineMail/> Email Us:</h3>
      ...
      <form action="" onSubmit={handleSubmit}>
         <input type="text" name="title" placeholder="Your Name" className="border border-slate-600 my-3 w-96 py-4 pl-2" onChange={(e)=>setTitle(e.target.value)} /><br/>
         <input type="text" name="title" placeholder="Your Email" className="border border-slate-600 my-3 w-96 py-4 pl-2" onChange={(e)=>setTitle(e.target.value)} /><br/>
         <input type="text" name="title" placeholder="Subject" className="border border-slate-600 my-3 w-96 py-4 pl-2" onChange={(e)=>setTitle(e.target.value)} /><br/>
         <input type="text" name="title" placeholder="Message" className="border border-slate-600 my-3 w-96 py-8 pl-2" onChange={(e)=>setTitle(e.target.value)} /><br/>
